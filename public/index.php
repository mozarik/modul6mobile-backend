...
$app->post('/createuser', function (Request $request, Response $response) {
	...
	if (!haveEmptyParameters(array('email', 'password', 'name', 'school'), $request, $response)) {
		...
		if ($result == USER_CREATED) {
			...
			$json_return = json_encode($message, JSON_PRETTY_PRINT);
			$response->getBody()->write($json_return);
...
$app->post('/userlogin', function (Request $request, Response $response) {
	if (!haveEmptyParameters(array('email', 'password'), $request, $response)) {
		...
		if ($result == USER_AUTHENTICATED) {
			...
			$json_return = json_encode($response_data, JSON_PRETTY_PRINT);
			$response->getBody()->write($json_return);
